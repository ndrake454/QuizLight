                    ...
                    <div class="mt-6 bg-gray-50 p-4 rounded-md">
                        ...
                        <div class="space-y-3 text-xs">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex-1">
                                    <span class="font-medium">750,000 - 1,000,000</span>: 
                                    <span class="text-gray-600">Consistent, dedicated studying - you're making significant progress</span>
                                </div>
                            </div>
                            <div class="flex items-center">
                                <div class="w-3 h-3 rounded-full bg-yellow-400 mr-2"></div>
                                <div class="flex-1">
                                    <span class="font-medium">500,000 - 750,000</span>: 
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex-1">
                                    <span class="font-medium">250,000 - 500,000</span>: 
                                    <span class="text-gray-600">Moderate effort - good foundation being built</span>
                                </div>
                            </div>
                            <div class="flex items-center">
                                <div class="w-3 h-3 rounded-full bg-blue-300 mr-2"></div>
                                <div class="flex-1">
                                    <span class="font-medium">100,000 - 250,000</span>: 
                                    <span class="text-gray-600">Getting started - consistent practice will improve this</span>
                                </div>
                            </div>
                            <div class="flex items-center">
