...
<div>
        ...
        <div class="container mx-auto text-center">
            ...
            <?php if (isLoggedIn()): ?>
                <div class="mt-8 flex flex-wrap justify-center gap-4">
                    <a href="/quiz-select" class="bg-white text-indigo-800 hover:bg-gray-100 font-bold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg">
                        Start Quiz
                    </a>
                </div>
            <?php else: ?>
                <div class="mt-8 flex flex-wrap justify-center gap-4">
                    <a href="/login" class="bg-white text-indigo-800 hover:bg-gray-100 font-bold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg">
                        Log In
                    </a>
                    <a href="/register" class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-indigo-800 font-bold py-3 px-6 rounded-lg transition-all duration-200">
                        Create Account
                    </a>
                </div>
            <?php endif; ?>
    ...
    <div class="py-16 px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow card-hover quiz-card">
                ...
                <?php if (isLoggedIn()): ?>
                    <div class="mt-8 flex flex-wrap justify-center gap-4">
                        <a href="/profile" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm">
                            View Profile
                        </a>
                    </div>
                <?php endif; ?>
            ...
            <div class="p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow card-hover quiz-card">
                ...
                <p class="text-gray-600">Discover the science behind <?php echo SITE_NAME; ?>'s adaptive learning technology and the principles that make it effective.</p>
                <div class="mt-8 flex flex-wrap justify-center gap-4">
                    <a href="/about" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm">
    ...
    <div x-data="{ showMasteryModal: false }">
        ...
        <?php include $this->viewPath . 'components/leaderboard-section.php'; ?>
        
        <!-- Include the mastery score modal -->
        <?php include $this->viewPath . 'components/mastery-score-modal.php'; ?>
    </div>
</div>