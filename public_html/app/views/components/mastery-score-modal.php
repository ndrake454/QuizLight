<!-- app/views/components/mastery-score-modal.php -->
                ...
                <div class="mt-4 text-left">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <h4 class="text-sm font-medium text-gray-900">Difficulty Multiplier</h4>
                                <p class="mt-1 text-xs text-gray-500">Higher difficulty questions contribute more to your score.</p>
                            </div>
                        </div>
                    </div>
