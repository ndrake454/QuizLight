 ...
 * Home Page
 * 
 * This is a renamed copy of the original index.php to avoid loops
 */
...
if (file_exists('includes/leaderboard-functions.php')) {
...
<?php
// Include leaderboard if the functions are available
if (function_exists('getTopPerformers')): 
    echo '<div x-data="{ showMasteryModal: false }">';
    
    // Try to include the leaderboard section if it exists
    if (file_exists('includes/leaderboard-section.php')) {
        include 'includes/leaderboard-section.php';
    }
    
    // Try to include the mastery score modal if it exists
    if (file_exists('includes/mastery-score-modal.php')) {
        include 'includes/mastery-score-modal.php';
    }
