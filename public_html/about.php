...
<div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg shadow-sm border border-indigo-100 my-8">
    <div class="flex items-center">
        ...
        <div>
            ...
            <a href="https://github.com/yourusername/quizlight" target="_blank" class="inline-flex items-center mt-3 px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 transition-colors duration-150 shadow-sm">
