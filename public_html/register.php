            ...
            <form method="POST" action="" x-data="{
                ...
                <div class="mb-6">
                    <button type="submit" 
                            ...
                            :disabled="!first_name || !last_name || !email || !password || !confirm_password || password !== confirm_password"
                            :class="{'opacity-50 cursor-not-allowed': !first_name || !last_name || !email || !password || !confirm_password || password !== confirm_password}">
                        Create Account
                    </button>
                </div>
